...
static_required_keys=(MARIADB_USER MARIADB_PASSWORD MARIADB_MCP_READER_USER MARIADB_MCP_READER_PASSWORD MARIADB_ROOT_PASSWORD MARIADB_PORT STRAVA_CLIENT_ID STRAVA_CLIENT_SECRET GOOGLE_HEALTH_CLIENT_ID GOOGLE_HEALTH_CLIENT_SECRET NTFY_TOPIC CYCLING_ANALYTICS_NTFY_TOPIC)
